...
I want to improve the way I set a layout using grid, flexbox, margins and paddings, and avoid vertical/ horizontal scrolling.
I still need to learn more about setting a box-shadow property.
